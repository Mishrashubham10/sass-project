...
CREATE TABLE "country_groups" (
	"text" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"name" text NOT NULL,
...
CREATE TABLE "product_customizations" (
	...
	"class_prefix" text,
	"product_id" uuid NOT NULL,
	"location_message" text DEFAULT 'Hey! It looks like you are from <b>{country}</b>. We support Parity Purchasing Power, so if you need it, user code <b>"{coupon}"</b> to get <b>{discount}%</b> off.' NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "country_group_discounts" ADD CONSTRAINT "country_group_discounts_country_group_id_country_groups_text_fk" FOREIGN KEY ("country_group_id") REFERENCES "public"."country_groups"("text") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "countries" ADD CONSTRAINT "countries_country_group_id_country_groups_text_fk" FOREIGN KEY ("country_group_id") REFERENCES "public"."country_groups"("text") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "user_subscription.clerk_user_id_index" ON "user_subscriptions" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE INDEX "user_subscription.stripe_customer_id_index" ON "user_subscriptions" USING btree ("stripe_customer_id");